...
if(isset($_POST['btnPost'])){
    ...
    if(!empty(trim($_POST['title'])) and !empty(trim($_POST['auther'])) and !empty(trim($_POST['categoryId'])) 
...
}else  if(!empty(trim($_POST['title'])) and !empty(trim($_POST['auther'])) and !empty(trim($_POST['categoryId'])) 
