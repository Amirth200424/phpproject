                            ...
                            <ul class="nav flex-column pe-3">
                                <li class="nav-item">
                                    <a
                                        ...
                                        href="/app-template2/admin-panel-template/index.php"
                                    >
                                        <i
                                ...
                                <li class="nav-item">
                                    <a
                                        ...
                                        href="/app-template2/admin-panel-template/pages/posts/index.php"
                                    >
                                        <i
                                ...
                                <li class="nav-item">
                                    <a
                                        class="nav-link link-body-emphasis text-decoration-none d-flex align-items-center gap-2"
                                        href="/app-template2/admin-panel-template/pages/categories/index.php"
                                    >
                                        <i
